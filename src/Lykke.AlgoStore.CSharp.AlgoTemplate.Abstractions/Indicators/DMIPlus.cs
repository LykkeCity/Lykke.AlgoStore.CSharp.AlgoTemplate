...
{
    public class DMIPlus : IIndicator
    {
        ...
        public DMIPlus(int period, bool isAverageTrueRangeSet = true)
        {
            _period = period;
            DirectionalMovementPluses = _period == 0 ? new Queue<double>() : new Queue<double>(_period);
